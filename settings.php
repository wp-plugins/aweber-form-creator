...
class AweberFormCreatorSettings{

    private $plugin_path;
    private $plugin_url;
    private $l10n;
    private $pluginTemplate;
    private $namespace = '_aweber_form_creator';
    private $settingName = 'Aweber Form Creator';
    ...
    function settings_page()
	{
		...
		<div class="wrap">
			...
			<h3>How to use Aweber Form Creator</h3>
			<p>Create a Aweber form by clicking on Aweber Form Creator>Add New on the main admin menu.
			<p>Put a Aweber form in your post or page by placing the shortcode tag <code>[aweber_form_creator id="%postid%"]</code> on your page or post</p>	
			<p><a href="http://www.thinklandingpages.com/aweber-form-creator/">Aweber Form Creator Quick Start Guide</a></p>			
